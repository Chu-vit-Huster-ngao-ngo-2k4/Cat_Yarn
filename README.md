...
bẫy ẩn dựa vào số gợi ý trên mỗi ô đã mở. 30 màn (5x5 → 9x9), có hệ thống xu,
...
- `style.css` — giao diện
- `levels/level01.json` … `level30.json` — dữ liệu từng màn (load bằng `fetch()` lúc khởi động, mỗi màn 1 file riêng cho dễ sửa)
